  ...
  return (
   <div className="col-span-3 py-10 bg-white rounded-lg shadow-md border border-gray-200 h-full overflow-hidden">
      ...
      <div className="block md:hidden">
        ...
        <div className="bg-[#5E2D4F] flex flex-row justify-between items-center px-2 py-4 rounded-lg w-[320px] h-[81px] gap-2 mb-4 mx-auto">
   ...
   {/* Mobile Property Grid */}
         <section className="px-4 mb-4">
          <div className="grid grid-cols-2 gap-3">
            <div className="grid gap-3">
              <div className="overflow-hidden rounded-lg shadow-lg" style={{ width: '158px', height: '89px' }}>
                <img src="/images/partners/1.png" alt="Property 1" className="w-full h-full object-cover" />
              </div>
              <div className="overflow-hidden rounded-lg shadow-lg" style={{ width: '158px', height: '95px' }}>
                <img src="/images/partners/2.png" alt="Property 2" className="w-full h-full object-cover" />
              </div>
            </div>
            <div className="grid gap-3">
              <div className="overflow-hidden rounded-lg shadow-lg" style={{ width: '158px', height: '56px' }}>
                <img src="/images/partners/3.png" alt="Property 3" className="w-full h-full object-cover" />
              </div>
              <div className="overflow-hidden rounded-lg shadow-lg" style={{ width: '158px', height: '130px' }}>
        ...
        {/* Mobile Our Partners */}
        <section className="text-center px-4 mb-1 mt-4">
          <h2 className="text-[20px] font-semibold text-black mb-1" style={{ fontFamily: "Poppins, sans-serif" }}>
            Our Partners
          </h2>

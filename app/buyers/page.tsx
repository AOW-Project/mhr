...
>
  {/* Title with gradient lines (h2 font size unchanged) */}
  <div className="absolute top-10 md:top-16 left-0 right-0 z-10">
    <div className="flex items-center justify-center px-4">
      ...
      <h2 className="text-[17px] sm:text-[20px] md:text-[36px] font-semibold text-white px-4 whitespace-nowrap relative z-10">
        Buying Guide
      </h2>
  ...
  <div className="relative z-10 max-w-7xl mx-auto pt-24 pb-4 px-4 flex flex-col items-start md:block">
    ...
    <div className="relative w-full md:w-[448px] text-left p-2 mb-6 md:absolute md:left-[40px] md:top-[140px]">
      <span className="font-semibold text-[16px] sm:text-[18px] md:text-[24px] text-pink-400">
        {/* Increased mobile font size for step title */}
        Step 1: Define Your Requirements
      </span>
      <p className="text-[15px] sm:text-[17px] md:text-[18px] mt-2 leading-snug sm:leading-normal">
        {/* Increased mobile font size for paragraph content */}
    ...
    <div className="relative w-full md:w-[448px] text-left p-2 mb-6 md:absolute md:left-[40px] md:top-[700px]">
      ...
      <p className="text-[14px] sm:text-[16px] md:text-[18px] mt-2 leading-snug sm:leading-normal">
        {/* Increased mobile font size for paragraph content */}
...
<section className="relative w-full bg-black pt-10 md:pt-16 pb-6 md:pb-16 text-white pl-3 md:pl-10">
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-3 md:px-6">
    ...
    <h2 className="text-[16px] md:text-[24px] font-semibold text-pink-400 mb-3 md:mb-5">
      Financing Options
    </h2>

    {/* Financing Options Content */}
    <div className="mb-4 md:mb-6 text-[14px] md:text-[20px] font-normal font-inter leading-relaxed">
    ...
    <h2 className="text-[16px] md:text-[24px] font-semibold text-pink-400 mb-3 md:mb-5 mt-5 md:mt-10">
      Need Assistance?
    </h2>
    <p className="mb-4 text-[14px] md:text-[20px] font-normal font-inter leading-relaxed">
    ...
    <div className="mb-2 text-[14px] md:text-[20px] font-normal font-inter leading-relaxed">
